...
public class Stair extends DirectionalBlock {
	...
	public static short getStairIdByType(StairType stairType) {
		switch (stairType) {
			...
			case ACACIA:        return 163;
			case DARK_OAK:      return 164;
			case OAKWOOD:
			default:			return 53;
		}
	}
	...
	public static StairType getStairTypeById(short id) {
		switch (id) {
			...
			case 163:   return StairType.ACACIA;
			case 164:   return StairType.DARK_OAK;
	...
	public synchronized BufferedImage getImage(double zoom) {
		...
		switch(this.stairType) {
			...
			case ACACIA:        img = ImageProvider.getImageByBlockOrItemID((short)163, (byte)0);   break;
			case DARK_OAK:      img = ImageProvider.getImageByBlockOrItemID((short)164, (byte)0);   break;
		}
