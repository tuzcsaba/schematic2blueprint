...
public class FlowerPot extends Block {
	...
	public synchronized BufferedImage getImage(double zoom) {
		...
		if (this.pottedPlant == PottedPlantType.NONE) {
			img = ImageProvider.getItemImage("flower_pot");
		} else {
			// get plant image, then copy to new image with pot "border"
			BufferedImage plantImg = null;
			switch(this.pottedPlant) {
				case ROSE:				plantImg = ImageProvider.getImage("flower_rose");				break;
				case DANDELION:			plantImg = ImageProvider.getImage("flower_dandelion");			break;
				case OAKSAPLING:		plantImg = ImageProvider.getImage("sapling_oak");			break;
