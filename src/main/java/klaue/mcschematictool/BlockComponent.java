...
public class BlockComponent extends JComponent {
	...
	public void paintComponent(Graphics g) {
		...
		if (img == null)
		{
			JOptionPane.showMessageDialog(null, "No image for block: " + String.valueOf(this.block.getId()) +":"+String.valueOf(this.block.getData()) , "Error", JOptionPane.ERROR_MESSAGE);
			return;
		}
